...
import { ChevronDown, ChevronUp, Headphones, MessageCircle, ShoppingBag, CreditCard, Truck, XCircle, RotateCcw, ShieldCheck, AlertTriangle } from "lucide-react";
...
const FAQS = [
  ...
  {
    category: "Disputes & Buyer Protection",
    icon: <ShieldCheck className="w-5 h-5 text-primary" />,
    items: [
      {
        q: "What is escrow protection?",
        a: "Escrow protection means your payment is held safely until delivery is confirmed. This reduces the risk of losing money if something goes wrong.",
      },
      {
        q: "When can I raise a dispute?",
        a: "You can raise a dispute if an item is not received, not as described, damaged, or if the seller becomes unresponsive. For fastest review, include a clear description and photos if you have them.",
      },
      {
        q: "How long does dispute review take?",
        a: "Our support team typically reviews disputes within 24 hours and updates you through the platform.",
      },
    ],
  },
  {
    ...
    items: [
      {
        q: "How do I report a product or seller?",
        a: "Use the Report/Dispute option in your relevant order details, or open the Disputes page and submit what happened. Our team will review and take action if needed.",
      },
      {
        q: "What happens after I report?",
        a: "You’ll receive updates during the review process. If a resolution is needed (refund or escrow release changes), our team coordinates it with both parties.",
      },
    ],
  },
];

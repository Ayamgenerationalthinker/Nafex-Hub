...
export default function Disputes() {
  ...
  const openFormFromQuery = searchParams.get("openForm");
  const shouldOpenForm = orderIdFromQuery.trim().length > 0 || openFormFromQuery === "1" || openFormFromQuery === "true";
  ...
  // If the user opens `/disputes?orderId=123`, auto-open the form with that order pre-filled.
  useEffect(() => {
        ...
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Add clear details (and photos if available). Our team reviews within 24 hours.
            </p>
          </DialogHeader>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="mt-2">
                <ImageUpload value={evidenceUrls} onChange={setEvidenceUrls} maxImages={5} label="Upload up to 5 photos" />
              </div>
              <p className="text-xs text-muted-foreground mt-2">
                Photos help us verify the issue faster. You can also submit without evidence.
              </p>
            </div>

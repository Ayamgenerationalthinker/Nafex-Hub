...
import { Phone, Instagram, Facebook, Mail, Settings, Loader2, Save } from "lucide-react";
...
const FIELDS: { key: keyof ContactSettings; label: string; placeholder: string; icon: React.ElementType; iconColor: string; type?: string }[] = [
  ...
  { key: "instagramLink", label: "Instagram Link", placeholder: "https://instagram.com/nafexhub", icon: Instagram, iconColor: "text-pink-500" },
  { key: "facebookLink", label: "Facebook Link", placeholder: "https://facebook.com/nafexhub", icon: Facebook, iconColor: "text-blue-500" },

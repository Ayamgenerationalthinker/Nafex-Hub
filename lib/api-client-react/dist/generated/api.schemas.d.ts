...
export declare const VerifyBusinessBodyApprovalStatus: {
...
export type CreateProductBodyVariantsItemAttributes = {
    [key: string]: unknown;
};
export type CreateProductBodyVariantsItem = {
    attributes?: CreateProductBodyVariantsItemAttributes;
    stock?: number;
    price?: string;
};

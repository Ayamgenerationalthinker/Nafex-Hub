...
export const GetFeaturedTopBusinessesResponse = zod.array(GetFeaturedTopBusinessesResponseItem)
...
export const CreateOrderResponse = zod.object({
  ...
  "totalPrice": zod.number(),
  "status": zod.enum(['pending', 'confirmed', 'packed', 'out_for_delivery', 'shipped', 'delivered', 'cancelled']),
 ...
 */
export const GetBusinessOrdersResponseItem = zod.object({
  "id": zod.number(),
  "userId": zod.number(),
  "businessId": zod.number(),
  "items": zod.array(zod.object({
...
export const GetBusinessOrdersResponse = zod.array(GetBusinessOrdersResponseItem)
...
export const UpdateProductStockBody = zod.object({
  "stock": zod.number().nullish().describe('null = not tracking, 0 = out of stock, positive = units available')
})
...
export const CreateDeliveryResponse = zod.object({
  ...
  "status": zod.enum(['created', 'assigned', 'picked_up', 'in_transit', 'delivered', 'failed', 'returned']),
  "pickupAddress": zod.string(),
  "deliveryAddress": zod.string(),
...
export const UpdateDeliveryStatusBody = zod.object({
  "status": zod.enum(['assigned', 'picked_up', 'in_transit', 'delivered', 'failed', 'returned']),
...
export const GetAdminDeliveriesResponse = zod.array(GetAdminDeliveriesResponseItem)
...
export const ReleasePayoutResponse = zod.unknown()
...
export const ProcessRefundResponse = zod.unknown()
...
export const GetDisputesResponseItem = zod.object({
  ...
  "orderId": zod.number(),
  "userId": zod.number(),
  "reason": zod.enum(['item_not_received', 'item_not_as_described', 'damaged_item', 'wrong_item', 'seller_unresponsive', 'other']),
  "description": zod.string(),
  "evidenceUrls": zod.array(zod.string()),
  "status": zod.enum(['open', 'under_review', 'resolved_buyer', 'resolved_seller', 'dismissed']),
